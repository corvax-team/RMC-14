...
public sealed class MechModuleSystem : MechInstallSystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<CCMMechModuleComponent, AfterInteractEvent>(OnUsed);
        SubscribeLocalEvent<CCMMechModuleComponent, InsertModuleEvent>(OnInsert);
    }

    private void OnUsed(EntityUid uid, CCMMechModuleComponent component, AfterInteractEvent args)
    {
    ...
    private void OnInsert(EntityUid uid, CCMMechModuleComponent component, InsertModuleEvent args)
    {
