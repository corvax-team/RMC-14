...
public sealed partial class CCMVehicleComponent : Component
{
    /// <summary>
...
public readonly record struct OnVehicleEnteredEvent(Entity<CCMVehicleComponent> Vehicle, EntityUid Operator);
...
/// </summary>
[ByRefEvent, UsedImplicitly]
public readonly record struct OnVehicleExitedEvent(Entity<CCMVehicleComponent> Vehicle, EntityUid Operator);
...
/// </summary>
[ByRefEvent, UsedImplicitly]
public record struct VehicleCanRunEvent(Entity<CCMVehicleComponent> Vehicle, bool CanRun = true);
