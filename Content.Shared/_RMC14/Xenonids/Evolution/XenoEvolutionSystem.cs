...
public sealed class XenoEvolutionSystem : EntitySystem
{
    ...
    private void OnXenoEvolveAction(Entity<XenoEvolutionComponent> xeno, ref XenoOpenEvolutionsActionEvent args)
    {
        ...
        if (!HivebrokenCheckPopup(xeno)) // CCM-14
            return;
    ...
    private bool HivebrokenCheckPopup(EntityUid xeno, bool doPopup = true) // CCM-14
    {
    ...
    private bool IsHivebrokenXeno(EntityUid uid) // CCM-14
    {
    ...
    private bool CanEvolvePopup(Entity<XenoEvolutionComponent> xeno, EntProtoId newXeno, bool doPopup = true)
    {
        ...
        if (!HivebrokenCheckPopup(xeno, doPopup)) // CCM-14
            return false;
    ...
    {
        if (!HivebrokenCheckPopup(xeno, false)) // CCM-14
            return false;
