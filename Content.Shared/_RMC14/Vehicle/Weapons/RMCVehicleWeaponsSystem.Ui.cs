...
public sealed partial class RMCVehicleWeaponsSystem
{
        ...
        EntityUid? operatorUid = null)
    {
        ...
        var entries = new List<RMCVehicleWeaponsUiEntry>(mountedSlots.Count);
    ...
    private RMCVehicleWeaponsUiEntry CreateMountedSlotUiEntry(
        RMCVehicleMountedSlot mountedSlot,
        ...
        VehicleWeaponsSeatComponent? operatorSeatComp)
    {
        ...
        return new RMCVehicleWeaponsUiEntry(
