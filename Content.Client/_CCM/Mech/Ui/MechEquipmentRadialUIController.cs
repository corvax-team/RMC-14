...
public sealed class MechEquipmentRadialUIController : UIController
{
    ...
    public void OpenRadialMenu(EntityUid mechEntity)
    {
        ...
        if (!_entManager.TryGetComponent<CCMMechComponent>(mechEntity, out var mechComp))
            return;
    ...
    private IEnumerable<RadialMenuOption> ConvertToButtons(CCMMechComponent mechComp) // При возникновении ошибок в данном участке кода обращаться к (Discord: ne_gost / <@784795496622718986>)
    {
