...
public sealed class TTSSystem : EntitySystem
{
    ...
    /// <summary>
    /// How far the TTS sound travels in world units when not whispering.
    /// </summary>
    private const float VoiceRange = 10f;

    /// <summary>
    /// How far a whispered TTS sound travels in world units.
    /// </summary>
    ...
    {
        return isWhisper ? WhisperRange : VoiceRange;
    }
}
