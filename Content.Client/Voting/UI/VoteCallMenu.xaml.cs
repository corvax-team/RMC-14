...
namespace Content.Client.Voting.UI
{
    ...
    public sealed partial class VoteCallMenu : BaseWindow
    {
        ...
        public VoteCallMenu()
        {
            ...
            // CCM vote menu dropdown style - start
            AttachActionButtonStyle(CreateButton);
            AttachActionButtonStyle(FollowButton);
            // CCM vote menu dropdown style - end
        }
        ...
        // CCM vote menu dropdown style - start
        private static void AttachActionButtonStyle(Button button)
        {
            ApplyActionButtonStyle(button);

            button.OnMouseEntered += _ => ApplyActionButtonStyle(button, hovered: true);
            button.OnMouseExited += _ => ApplyActionButtonStyle(button);
            button.OnKeyBindDown += args =>
            {
                if (args.Function != EngineKeyFunctions.UIClick)
                    return;

                ApplyActionButtonStyle(button, pressed: true);
            };
        ...
        private static void ApplyActionButtonStyle(Button button, bool hovered = false, bool pressed = false)
        {
            ...
            button.Label.FontColorOverride = pressed ? Color.Black : Color.FromHex("#EEF4FB");
        }
        // CCM vote menu dropdown style - end
    }
