...
public sealed partial class AtmosAlarmEntryContainer : BoxContainer
{
    ...
    public AtmosAlarmEntryContainer(NetEntity uid, EntityCoordinates? coordinates)
    {
        ...
        // Load fonts
        var headerFont = new VectorFont(_cache.GetResource<FontResource>("/Fonts/Bedstead/bedstead.otf"), 11);
        var normalFont = new VectorFont(_cache.GetResource<FontResource>("/Fonts/Bedstead/bedstead.otf"), 11);
        var smallFont = new VectorFont(_cache.GetResource<FontResource>("/Fonts/Bedstead/bedstead.otf"), 10);
