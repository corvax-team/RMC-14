...
ent-RMCStockAttachmentCollapsibleBase = { ent-['RMCStockAttachmentBase', 'RMCAttachableToggleableBase'] }

  .desc = { ent-['RMCStockAttachmentBase', 'RMCAttachableToggleableBase'].desc }
