...
cm-fpv-drone-laptop-available = AVAILABLE DRONES
cm-fpv-drone-laptop-role = ROLE
cm-fpv-drone-laptop-status = STATUS
cm-fpv-drone-laptop-operator = OPERATOR
cm-fpv-drone-laptop-health = HEALTH
cm-fpv-drone-laptop-detonate = DETONATE
cm-fpv-drone-laptop-unlink = UNLINK
