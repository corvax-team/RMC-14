...
# Throw Parasite
cm-xeno-throw-parasite-no-parasites = We don't have any regular parasites stored!
...
cm-xeno-throw-parasite-stash-royal = We store the royal child for safekeeping. Now sheltering: {$cur_royals}/{$max_royals} royal parasites.
cm-xeno-throw-parasite-unstash-royal = We grab a royal child from our storage. Now sheltering: {$cur_royals}/{$max_royals} royal parasites.
rmc-xeno-throw-parasite-reserves = {CAPITALIZE(SUBJECT($xeno))} {CONJUGATE-HAVE($xeno)} {$rev_paras} regular and {$rev_royals} royal parasite ghost {$rev_paras ->
   [one] role
   *[other] roles
} available.
