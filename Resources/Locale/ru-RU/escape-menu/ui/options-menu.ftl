...
ui-options-auto-fill-highlights = Автозаполнение подсветок данными персонажа
...
ui-options-function-text-cursor-word-left = Переместить курсор влево по словам
ui-options-function-text-cursor-word-right = Переместить курсор вправо по словам
...
ui-options-function-text-cursor-select-word-left = Расширить выделение влево по словам
ui-options-function-text-cursor-select-word-right = Расширить выделение вправо по словам
...
ui-options-function-text-backspace = Удалить назад
...
ui-options-function-multiline-text-submit = Подтвердить (многострочно)
...
ui-options-speech-bubble-speaker-opacity = Прозрачность говорящего в облачках
...
ui-options-enable-classic-overlay = Вернуть классический режим оверлея антагов
ui-options-admin-player-panel = Список игроков админ-меню
ui-options-admin-playerlist-separate-symbols = Показывать отдельные символы для каждого типа антага
ui-options-admin-playerlist-character-color = Окрашивать имена персонажей антагов
ui-options-admin-playerlist-roletype-color = Окрашивать типы ролей
ui-options-admin-player-tab-symbol-setting = Символы антага в колонке персонажа
...
ui-options-enable-overlay-symbols = Добавлять символ антага к тексту
ui-options-enable-overlay-playtime = Показывать наигранное время
ui-options-enable-overlay-starting-job = Показывать стартовую должность
ui-options-overlay-merge-distance = Дистанция объединения стеков
