...
rmc-dropship-pre-hijack = Этот терминал не будет работать ещё { $minutes } { $minutes ->
        [one] минуту
        [few] минуты
       *[other] минут
    }.
...
rmc-dropship-weapons-point-gun = В него установлено { $weapon }.
rmc-dropship-weapons-point-ammo = В него заряжен { $ammo }.
