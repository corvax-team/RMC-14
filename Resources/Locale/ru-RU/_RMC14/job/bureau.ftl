...
rmc-ghost-name-bureau-marshal = Колониальный Маршал (Дружественный)
...
rmc-job-name-bureau-riot-control-team-leader = Лидер Отряда по Контролю Беспорядков БКМ
rmc-job-prefix-bureau-riot-control-team-leader = БКМ ЛОКБ
rmc-ghost-name-bureau-observer = Уполномоченный Наблюдатель ГИОР (Дружественный)
rmc-job-name-bureau-observer = Уполномоченный Наблюдатель ГИОР
rmc-job-prefix-bureau-observer = УНГИОР
rmc-ghost-name-icb = Представитель "Монокля" (Дружественный)
rmc-job-name-icb = Представитель "Монокля"
rmc-job-prefix-icb = ПАО
