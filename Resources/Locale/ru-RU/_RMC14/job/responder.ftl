...
rmc-ghost-role-information-responder-rules =
    ...
    Вы по факту являетесь лицом администрации. Продумывайте и пишите свои факсы можно внимательнее и ответственно.
    ...
    ЕСЛИ СОМНЕВАЕТЕСЬ, ИЛИ ПОЛУЧИЛИ ФАКС, ОТВЕТ НА КОТОРЫЙ ТРЕБУЕТ ВМЕШТЕЛЬСТВА, НЕ БОЙТЕСЬ ПИСАТЬ В АХЕЛП!!!
    Звоните морпехам по телефону ТОЛЬКО при наличии по настоящему стоящей причины. Ваш основной метод коммуникации должен оставаться факсом.
    Не при каких обстоятельствах НЕ ИСПОЛЬЗУЕТЕ РАДИО ДЛЯ ОБЩЕНИЯ. Оно только для тогоч, чтобы слушать, не говорить.
...
rmc-job-description-tse-responder = "Вы действуете от имени Империи Миртана и отвечаете на факсы, отправленные вонному Аташе империи."
#CMB fax responder
