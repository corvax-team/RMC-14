...
rmc-attachable-examine-condition-unwielded = предмет [bold]в одной руке[/bold]
...
rmc-attachable-examine-ranged-burst-scatter = [color={ $colour }]{ $sign }{ $burstScatterMult }[/color] к разбросу очереди.
rmc-attachable-examine-ranged-shots-per-burst = [color={ $colour }]{ $sign }{ $shots }[/color] выстрелов в очереди.
rmc-attachable-examine-ranged-fire-delay = [color={ $colour }]{ $sign }{ TOSTRING($fireDelay, "F2") }[/color] сек. задержки между выстрелами.
rmc-attachable-examine-ranged-recoil = [color={ $colour }]{ $sign }{ $recoil }[/color] к отдаче.
...
rmc-attachable-examine-speed-walk = [color={ $colour }]{ $sign }{ TOSTRING($speed, "F2") }[/color] к скорости шага.
rmc-attachable-examine-speed-sprint = [color={ $colour }]{ $sign }{ TOSTRING($speed, "F2") }[/color] к скорости бега.
rmc-attachable-examine-wield-delay = [color={ $colour }]{ $sign }{ $delay }[/color] сек. задержки взятия в руки.