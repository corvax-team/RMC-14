...
rmc-disarm-break-pulls-others = { CAPITALIZE(THE($performerName)) } вырвал { THE($object) } из хватки { THE($targetName) }!
rmc-disarm-break-pulls-self = Вы вырвали { THE($object) } из захвата { THE($targetName) }!
rmc-disarm-break-pulls-target = { CAPITALIZE(THE($performerName)) } вырвал { THE($object) } из ваших рук!
rmc-disarm-attempt-others = { CAPITALIZE(THE($performerName)) } попытался обезоружить { THE($targetName) }!
rmc-disarm-attempt-self = Вы пытаетесь обезоружить { THE($targetName) }!
rmc-disarm-attempt-target = { CAPITALIZE(THE($performerName)) } попытался вас обузоружить!
