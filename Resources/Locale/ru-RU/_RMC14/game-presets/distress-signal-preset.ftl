...
rmc-distress-signal-majormarinevictory-timeout = [color=green]Улей был уничтожен![/color]
...
cm-distress-signal-minorxenovictory = [color=purple]Ксеноморфы угнали десантный корабль[/color], [color=green]но были уничтожены колониальными морпехами![/color]
rmc-distress-signal-minorxenovictory-timeout = [color=purple]Ксеноморфы угнали десантный корабль[/color], [color=yellow]но корабль рухнул до того, как выжившие морпехи успели сбежать![/color]
...
rmc-distress-signal-fallen =
    В честь павших во время операции бойцов:
    { $fallen }
...
rmc-distress-signal-got-jelly = { $receiver } is awarded the { $award }: '{ $awardDescription }' от { $giver }
