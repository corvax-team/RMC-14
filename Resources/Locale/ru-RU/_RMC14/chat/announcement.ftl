...
rmc-announcement-message-raw = [font size=16][bold][color=#CECECE]{ $author }[/color][/bold][/font][font size=16][color=red]
    ...
    { $message }
rmc-announcement-ares-message = [color=#CECECE][font size=16][bold]АРЕС v3.2 Постановка боевой задачи[/bold][/font][/color][color=red][font size=16][bold]
    
    { $message }[/bold][/font][/color]
rmc-announcement-ares-lz-designated =
    Боевой приказ отдан:
    
    Зона { $name } назначена основной зоной высадки.
...
rmc-announcement-ares-command = [color=#CECECE][font size=16][bold]ARES v3.2[/bold][/font][/color][color=red][font size=16]
    ...
    { $message }[/font][/color]
rmc-announcement-unidentified-lifesigns = [color=#CECECE][font size=16][bold]Неопознанные сигнатуры жизни[/bold][/font][/color][color=red][font size=16][bold]
    
    Обнаружено примерно ({ $count }) неопознанных форм жизни на десантном корабле { $name }. Рекомендация: загерметизировать все выходы, включая воздуховоды и вентиляцию.[/bold][/font][/color]
rmc-announcement-shipside-header = Пожалуйста, введите текст объявления для экипажа