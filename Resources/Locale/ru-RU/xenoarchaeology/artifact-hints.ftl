...
xenoarch-trigger-examine-pulsing = Из поверхности артефакта торчит пучка проводов.
xenoarch-trigger-examine-timer = Углубления и царапины покрывают поверхность... Вы можете едва различить номер: [italic]{ $time }[/italic]
xenoarch-effect-puddle = Изливает лужу следующих реагентов: { $reagent }
xenoarch-effect-foam = Создает и вспенивает следующие реагенты: { $reagent }