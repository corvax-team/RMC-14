...
cm-job-name-xeno-carrier = Переносчик
CMJobXenoCarrier = Переносчик
...
cm-job-name-xeno-lesser-drone = Низший трутень
CMJobXenoLesserDrone = Низший трутень
...
role-timer-xeno-drones = эволюция трутней и трутны
