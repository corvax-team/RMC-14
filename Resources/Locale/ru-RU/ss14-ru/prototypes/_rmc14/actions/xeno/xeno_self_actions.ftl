...
ent-ActionXenoGenerateEggs = Создание яиц (50)
    .desc = Создавайте яйцо каждые 30 секунд. После создание оно будет размещено в вашем хранилище. [color=cyan]Потребляет 15 плазмы каждые 2 секунды.[/color]
