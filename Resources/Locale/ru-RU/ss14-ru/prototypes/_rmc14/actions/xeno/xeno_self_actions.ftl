...
ent-ActionXenoDefensiveShield = Защитный щит (50)
    .desc = Получите временный щит, блокирующий следующие 200 единиц урона (и неуязвимый к взрывному урону), который будет действовать 7 секунд. Любой урон, нанесённый щиту, будет уменьшен на 10 перед вычетом его из прочности щита. [color=green] При атаке противника время действия частично перезарядится[/color]Полем
...
ent-ActionXenoGenerateEggs = Генерировать яйца (50)
    .desc = Создавайте яйцо каждые 30 секунд, которое входит в ваше хранилище.[color=cyan]Поглощает 15 плазменных каждые 2 секунды.[/color]
