...
ent-RCMWallShivaFab = prefabricated structure wall
    .desc = This structure is made of metal support rods and robust poly-kevlon plastics. A derivative of the stuff used in UA ballistics vests, UNMC and SPP uniforms. These walls are pulled taught and have been reinforced into a more permanent structure.
