...
ent-RMCPouchFlareL96 = подсумок для фальшфейеров L96
    ...
    .suffix = RCM
ent-RMCPouchFlareR44 = подсумок для фальшфейеров R44
    .desc = Подсумок для фальшфейеров стандартной выдачи СССП, предназначенный для хранения осветительных ракет R44. Заправляется набором фальшфейеров R44.
    .suffix = СССП
ent-RMCPouchFlareC18 = подсумок для фальшфейеров C18
    .desc = Чёрный подсумок, который чаще всего выдается ЧВК Vitezstvi для хранения фальшфейеров. Заправляется набором фальшфейеров C18.
    .suffix = ЧВК
