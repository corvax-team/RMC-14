ent-RMCArmorM4RLight = лёгкий бронежилет M4R БКМ
    .desc = Тёмный комплект бронежилета, являющийся модификацией варианта бронежилета охраны M3. Предназначен для борьбы с беспорядками и подавления демонстраций. На боку имеется металлическая эмблема с надписью «БКМ БОРЬБА С БЕСПОРЯДКАМИ». Законы Земли распространяются далеко за пределы Солнечной системы.
