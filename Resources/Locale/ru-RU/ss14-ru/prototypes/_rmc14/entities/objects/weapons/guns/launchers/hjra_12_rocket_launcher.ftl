ent-RMCWeaponLauncherHJRA12 = ручной противотанковый гранатомёт HJRA-12
    .desc = Ручной противотанковый гранатомёт HJRA-12 является стандартным противотанковым оружием СНП. Он разработан как простое в использовании средство для вывода из строя или уничтожения бронетехники.
ent-RMCRocketHJRA12 = противотанковая ракета HJRA-12
    .desc = Ракета для стандартного ручного противотанкового гранатомёта СНП HJRA-12. Это стандартная противотанковая ракета, предназначенная для вывода из строя или уничтожения вражеских машин.
