...
ent-RMCExplosiveBreachingChargeRubber = Нелетальный заряд X17
    .desc = Взрывное устройство, используемое для проникновения в помещения и защищающее оператора от взрыва. В отличии от стандартного заряда, X17 выпускает заряд резиновой дроби в конусообразном паттерне. Создано скорее для того, чтобы калечить, а не убивать.
