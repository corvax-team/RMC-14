...
ent-RMCScoutSpecEquipmentCase = кейс снаряжения скаута
    ...
    ПРИМЕЧАНИЕ: Вы не можете поместить предметы обратно в этот кейс.
ent-RMCPyroSpecEquipmentCase = кейс снаряжения пиротехника
    .desc =
    Большой кейс, содержащий установку для сжигания M34-T, броню и шлем пиротехника M35, гибкую систему дозаправки Broiler-T и дополнительное снаряжение.
            
    ПРИМЕЧАНИЕ: Вы не можете поместить предметы обратно в этот кейс.
ent-RMCKitLoader = набор заряжающего
    .desc =
    Большой набор, содержащий всё необходимое, чтобы превратить обычного рядового в заряжающего и помощника подрывника.
    ...
    Шаг третий: Убедитесь, что специалист держит пусковую установку обеими руками.
