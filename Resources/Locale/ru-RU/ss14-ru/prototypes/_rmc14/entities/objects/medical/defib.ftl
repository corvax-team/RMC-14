...
ent-RMCDefibrillatorCompact = Компактный дефибриллятор
    .desc = Этот конкретный дефибриллятор обладает вдвое увеличение заряда по сравнению со стандартным аварийным дефибриллятором, но может поместиться в вашем кармане.
