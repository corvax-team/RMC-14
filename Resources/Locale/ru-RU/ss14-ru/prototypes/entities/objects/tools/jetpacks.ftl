...
ent-JetpackSecurity = джетпак СБ
    .suffix = Пустой
    .desc = Компактный реактивный ранец, используемый службой безопасности станции при патрулировании внешней территории станции. Не предназначен для дальних перелётов.
